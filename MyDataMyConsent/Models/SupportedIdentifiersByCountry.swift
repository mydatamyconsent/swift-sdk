//
// SupportedIdentifiersByCountry.swift
//
...
public struct SupportedIdentifiersByCountry: Codable, JSONEncodable, Hashable {

    public var iso2: String?
    public var name: String?
    public var flag: String?
    public var individualIdentifiers: [SupportedIdentifier]?
    public var organizationIdentifiers: [SupportedIdentifier]?

    public init(iso2: String? = nil, name: String? = nil, flag: String? = nil, individualIdentifiers: [SupportedIdentifier]? = nil, organizationIdentifiers: [SupportedIdentifier]? = nil) {
        self.iso2 = iso2
        self.name = name
        self.flag = flag
