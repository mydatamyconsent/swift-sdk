//
// FinancialAccountTermDeposit.swift
//
...
public struct FinancialAccountTermDeposit: Codable, JSONEncodable, Hashable {
    ...
    public init(type: String, accountNumber: String, accountType: TermDepositAccountType, issuerName: String, issuerLogoUrl: String, currentValue: Double, currencyCode: String, accountDetails: TermDepositAccountDetails) {
        self.type = type
