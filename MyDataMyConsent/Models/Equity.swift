...
public struct Equity: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, name: String, identifier: String, balance: Double, profile: Profile, summary: EquitySummary, maskedAccountNumber: String, linkedAccountRef: String, version: Float) {
        self.id = id
        self.name = name
