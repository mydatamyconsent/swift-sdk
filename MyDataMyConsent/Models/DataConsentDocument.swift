...
public struct DataConsentDocument: Codable, JSONEncodable, Hashable {
    ...
    public var issuer: DataConsentDocumentIssuer
    /** Digital signatures. */
    public var digitalSignatures: [DocumentDigitalSignature]

    public init(id: String, name: String, category: String, identifier: String, fieldTitle: String, fieldSlug: String, issuedAtUtc: Date, expiresAtUtc: Date? = nil, issuer: DataConsentDocumentIssuer, digitalSignatures: [DocumentDigitalSignature]) {
        self.id = id
        self.name = name
