...
public struct ConsentRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, templateId: String? = nil, consentId: String? = nil, title: String, description: String, purpose: String? = nil, dataLife: Life? = nil, collectables: [CollectibleTypes], receiver: ConsentRequestReceiver, status: DataConsentStatus, createdAtUtc: Date, expiresAtUtc: Date, approvedAtUtc: Date? = nil, dataAccessExpiresAtUtc: Date? = nil, rejectedAtUtc: Date? = nil, revokedAtUtc: Date? = nil) {
        self.id = id
