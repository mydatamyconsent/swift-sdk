...
public struct DataConsentDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, requestId: UUID, templateId: UUID? = nil, title: String, description: String, purpose: String? = nil, status: DataConsentStatus, transactionId: String? = nil, requestedAtUtc: Date, approvedAtUtc: Date, dataAccessExpiresAtUtc: Date, revokedAtUtc: Date? = nil) {
        self.id = id
