...
public struct DataConsentDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, templateId: UUID? = nil, title: String, description: String, purpose: String? = nil, status: DataConsentStatus, transactionId: String? = nil, approvedAtUtc: Date, dataAccessExpiresAtUtc: Date, revokedAtUtc: Date? = nil) {
        self.id = id
