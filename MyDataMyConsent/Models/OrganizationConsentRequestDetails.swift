//
// OrganizationConsentRequestDetails.swift
//
...
public struct OrganizationConsentRequestDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(receiver: String, id: String, templateId: String? = nil, consentId: String? = nil, title: String, description: String, purpose: String? = nil, status: DataConsentStatus, transactionId: String? = nil, createdAtUtc: Date, expiresAtUtc: Date) {
