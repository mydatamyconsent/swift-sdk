...
public struct AllergyDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, name: CodeableConcept? = nil, category: [String], levelStatus: String? = nil, status: CodeableConcept? = nil, clinicalStatus: CodeableConcept? = nil, reactions: [AllergyIntoleranceReaction], recordedAtUtc: Date? = nil) {
        self.id = id
        self.name = name
