...
public struct FinancialAccountMutualFund: Codable, JSONEncodable, Hashable {
    ...
    public init(type: String, id: String, name: String, identifier: String, balance: Double, profile: Profile, summary: MutualFundSummary, maskedAccountNumber: String, linkedAccountRef: String, version: Float) {
        self.type = type
        self.id = id
        self.name = name
