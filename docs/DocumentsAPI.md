...
let documentIssueRequest = DocumentIssueRequest(documentTypeId: 123, documentIdentifier: "documentIdentifier_example", description: "description_example", receiver: DocumentReceiver(identifiers: [StringStringKeyValuePair(key: "key_example", value: "value_example")], identificationStrategy: IdentificationStrategy()), expiresAtUtc: Date(), metadata: "TODO") // DocumentIssueRequest | Document issue request MyDataMyConsent.DeveloperApi.Models.DocumentIssueRequest.
